...
Private Sub ChkBreak_Click()
  TxtOutput.Text = HexCode(TxtInput.Text)
End Sub
...
Function HexCode(HexString As String) As String
  Dim Code As String, I As Integer
  For I = 1 To Len(HexString)
    If ChkPercent.Value = 1 Then
      Code = Code & "%"
    End If
    Code = Code & Hex(Asc(Mid(HexString, I, 1)))
