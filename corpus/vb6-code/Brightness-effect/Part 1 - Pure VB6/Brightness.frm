...
Begin VB.Form frmBrightness 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00C0C0C0&
   Caption         =   "Brightness Example - Pure VB - www.tannerhelland.com"
   ClientHeight    =   5730
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6285
...
Private Sub CmdBrightness_Click()
    ...
    DrawVBBrightness Picture1, Picture1, CSng(Val(TxtBrightness.Text)) / 100!
    
End Sub

'A simple subroutine that will change the brightness of a picturebox using nothing but PSet and Point.
Public Sub DrawVBBrightness(ByRef dstPicture As PictureBox, ByRef srcPicture As PictureBox, ByVal newBrightness As Single)
    ...
    For y = 0 To tmpHeight
        ...
        TempColor = srcPicture.Point(x, y)
