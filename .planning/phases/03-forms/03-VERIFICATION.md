...
covered_digest: "v1:sha256:d3b9495447360f0990de3923acc831291cf670f1a62ddaa4914339af2084ef18"
...
corrections_applied:
  - item: "covered_digest refreshed after the verification passed"
    from: "v1:sha256:1092a47456bbc39acfd4c41e758b448d8aa68db41996558f77aefd54e4534f96"
    to: "v1:sha256:d3b9495447360f0990de3923acc831291cf670f1a62ddaa4914339af2084ef18"
    reason: "Two covered files changed after this report was written, by commits 54e54a4 and 480f751 only. 54e54a4 splits the FRM range row in REQUIREMENTS.md into one row per requirement, and each status it writes is a status this report itself established. 480f751 is the phase.complete write that ticks the Phase 3 checkbox and its progress row, which is the mechanical result of this report passing. Neither commit adds a claim that this verification did not assess, so the digest was recomputed rather than the phase re-verified. No source file changed: git diff --name-only b139b9f..HEAD lists no .rs file."
