...
#[test]
fn the_committed_map_holds_one_thousand_six_hundred_and_ninety_four_graded_records_and_no_differing_byte()
 {
...
#[test]
fn the_committed_map_states_ten_layouts_that_agree_with_the_walk() {
    let map = committed();
    assert_eq!(map.layouts.len(), 10);
